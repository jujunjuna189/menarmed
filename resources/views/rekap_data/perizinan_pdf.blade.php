...
<head>
    ...
    <style>
        ...
        .col-kendaraan { width: 80px; }
    </style>
</head>
<body>
    <div class="header">
        <h2>Rekap Data Perizinan</h2>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $val->keluar ? \Carbon\Carbon::make($val->keluar)->format('d/m/Y H:i:s') : '-' }}</td>
                <td>{{ $val->masuk ? \Carbon\Carbon::make($val->masuk)->format('d/m/Y H:i:s') : '-' }}</td>
                <td>{{ $val->tujuan }}</td>
