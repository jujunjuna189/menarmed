    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body border-bottom py-3">
                <form action="{{ route('report.kendaraan') }}" method="GET" class="d-flex w-100" id="filterForm">
                    ...
                    <div class="ms-auto text-muted d-flex">
                        ...
                        <a href="{{ route('report.kendaraan.export', request()->all()) }}" class="btn btn-success btn-sm ms-2">
                            Export Excel
                        </a>
                        <a href="{{ route('report.kendaraan.pdf', request()->all()) }}" class="btn btn-danger btn-sm ms-2">
                            Export PDF
                        </a>
                    </div>
                </form>
            ...
            <div class="card-footer d-flex align-items-center">
                ...
                <ul class="pagination m-0 ms-auto">
                    ...
                    @foreach($controller->counterPagination($report->lastPage(), $report->currentPage(), 'report.kendaraan', request()->all()) as $p)
