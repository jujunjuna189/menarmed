...
class PerizinanKendaraanQ1Batch2Seeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        while ($currentDate->lte($endDate)) {
            ...
            // Tambahkan 6 giat per minggu (sehingga total Q1 makin banyak dan bervariasi)
            for ($i = 0; $i < 6; $i++) {
        ...
        $this->command->info('Batch 2 Extra Perizinan Kendaraan Q1 seeder completed successfully.');
    }
}
